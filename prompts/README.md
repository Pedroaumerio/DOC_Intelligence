...
Inclui as mensagens de git ("faça o commit", "de o push") e as perguntas, que
não entram no resumo curado em [`../docs/prompts.md`](../docs/prompts.md).
...
| 31–32 | diretório de prompts curado, push |
| 33 | tirar as perguntas do resumo curado |
