...
- **Ver arquivo enviado** — abre num modal o próprio arquivo que a pessoa mandou (o `File` fica em memória na sessão, não é persistido — fato d), para conferir o que a máquina leu sem ter que procurar o arquivo no dispositivo de novo. Imagem com girar (fato b — foto torta) e tamanho real; PDF no leitor do navegador. Não é o visualizador lado a lado com zoom de precisão — esse fica para a fatia da conferência.
